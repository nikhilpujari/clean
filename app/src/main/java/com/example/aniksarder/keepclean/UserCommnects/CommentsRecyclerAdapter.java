package com.example.aniksarder.keepclean.UserCommnects;
...
public class CommentsRecyclerAdapter extends RecyclerView.Adapter<CommentsRecyclerAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView CommentUserMessage;
        ...
        public void setComment_message(String message){
            ...
            CommentUserMessage = mView.findViewById(R.id.comment_message);
            CommentUserMessage.setText(message);

        }
        public void setUserData(String name, String image) {

            CommentUserImage = mView.findViewById(R.id.comment_user_Profile);
